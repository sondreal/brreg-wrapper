...
async def main():
    ...
    try:
        ...
        try:
            ...
            print("\nJSON representation:")
            equinor_dict = equinor.model_dump(mode="json", by_alias=True, exclude_none=True)
            print(json.dumps(equinor_dict, indent=2, ensure_ascii=False)[:500] + "...\n")
        ...
        results = await client.get_multiple_enheter([org_numbers[0], org_numbers[1], org_numbers[2]])
        ...
        print(f"Found {search_results.page.totalElements} organizations matching 'Microsoft'")
        ...
        print(f"Found {len(org_forms.field_embedded.organisasjonsformer)} organization forms")
